...
require (
	cloud.google.com/go/storage v1.57.2 // @grafana/backend-platform
	...
	github.com/go-sql-driver/mysql v1.9.3 // @grafana/backend-platform
	...
	go.opentelemetry.io/otel/sdk v1.40.0 // @grafana/backend-platform
	go.opentelemetry.io/otel/trace v1.40.0 // @grafana/backend-platform
	...
	google.golang.org/api v0.256.0 // @grafana/backend-platform
...
require (
	...
	google.golang.org/genproto v0.0.0-20251124214823-79d6a2a48846 // indirect; @grafana/backend-platform
)

require (
	cloud.google.com/go/kms v1.23.2 // @grafana/backend-platform
	github.com/Azure/azure-sdk-for-go/sdk/azidentity v1.13.1 // @grafana/backend-platform
	...
	go.opentelemetry.io/otel/exporters/otlp/otlptrace v1.38.0 // @grafana/backend-platform
	go.opentelemetry.io/otel/exporters/otlp/otlptrace/otlptracegrpc v1.38.0 // @grafana/backend-platform
...
require (
	...
	go.opentelemetry.io/otel v1.40.0 // @grafana/backend-platform
