...
require (
	...
	k8s.io/apimachinery v0.33.4 // @grafana/grafana-app-platform-squad
	k8s.io/apiserver v0.29.0 // @grafana/grafana-app-platform-squad
	k8s.io/client-go v0.33.4 // @grafana/grafana-app-platform-squad
	k8s.io/component-base v0.33.4 // @grafana/grafana-app-platform-squad
