...
require (
	...
	golang.org/x/crypto v0.51.0 // @grafana/backend-platform
	...
	google.golang.org/api v0.283.0 // @grafana/backend-platform
...
require (
	...
	golang.org/x/text v0.37.0 // @grafana/backend-platform
...
require (
	...
	golang.org/x/mod v0.35.0 // @grafana/backend-platform
