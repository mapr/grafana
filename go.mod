...
require (
	...
	github.com/prometheus/client_golang v1.24.0 // @grafana/alerting-squad-backend
	github.com/prometheus/client_model v0.6.2 // @grafana/backend-platform
	github.com/prometheus/common v0.70.0 // @grafana/alerting-squad-backend
	...
	golang.org/x/crypto v0.53.0 // @grafana/backend-platform
	...
	golang.org/x/sync v0.21.0 // @grafana/alerting-squad-backend
	golang.org/x/time v0.3.0 // @grafana/backend-platform
	golang.org/x/tools v0.45.0 // @grafana/grafana-as-code
...
require (
	...
	golang.org/x/text v0.38.0 // @grafana/backend-platform
...
require (
	...
	golang.org/x/mod v0.36.0 // @grafana/backend-platform
