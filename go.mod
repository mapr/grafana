...
require (
	...
	google.golang.org/genproto v0.0.0-20250715232539-7130f93afb79 // indirect; @grafana/backend-platform
)

require (
	cloud.google.com/go/kms v1.22.0 // @grafana/backend-platform
	github.com/Azure/azure-sdk-for-go/sdk/azidentity v1.10.1 // @grafana/backend-platform
	...
	go.opentelemetry.io/contrib/instrumentation/google.golang.org/grpc/otelgrpc v0.62.0 // @grafana/plugins-platform-backend
	go.opentelemetry.io/contrib/propagators/jaeger v1.21.1 // @grafana/backend-platform
	go.opentelemetry.io/otel/exporters/otlp/otlptrace v1.37.0 // @grafana/backend-platform
	go.opentelemetry.io/otel/exporters/otlp/otlptrace/otlptracegrpc v1.37.0 // @grafana/backend-platform
