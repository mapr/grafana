...
require (
	...
	github.com/go-openapi/strfmt v0.26.0 // @grafana/alerting-squad-backend
	...
	go.opentelemetry.io/otel/sdk v1.41.0 // @grafana/backend-platform
	go.opentelemetry.io/otel/trace v1.41.0 // @grafana/backend-platform
...
require (
	...
	github.com/go-openapi/loads v0.23.3 // @grafana/alerting-squad-backend
	github.com/go-openapi/runtime v0.29.3 // @grafana/alerting-squad-backend
...
require (
	...
	go.opentelemetry.io/otel v1.41.0 // @grafana/backend-platform
