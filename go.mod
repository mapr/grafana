...
require (
	...
	github.com/stretchr/testify v1.12.1 // @grafana/backend-platform
	...
	golang.org/x/crypto v0.55.0 // @grafana/backend-platform
...
require (
	...
	golang.org/x/text v0.41.0 // @grafana/backend-platform
...
require (
	...
	github.com/Azure/azure-sdk-for-go/sdk/azidentity v1.14.0 // @grafana/backend-platform
...
require (
	...
	github.com/microsoft/go-mssqldb v1.11.0 // @grafana/grafana-bi-squad
	...
	golang.org/x/mod v0.38.0 // @grafana/backend-platform
