...
require (
	...
	go.opentelemetry.io/otel/trace v1.44.0 // @grafana/backend-platform
...
require (
	...
	go.opentelemetry.io/contrib/propagators/jaeger v1.44.0 // @grafana/backend-platform
...
require (
	...
	go.opentelemetry.io/otel v1.44.0 // @grafana/backend-platform
