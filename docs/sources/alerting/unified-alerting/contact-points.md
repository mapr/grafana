...
1. Choose whether to send a predefined test notification, or choose custom and add your own custom annotations and labels to include in the notification.
