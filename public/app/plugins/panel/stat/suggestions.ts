...
import { FieldType, VisualizationSuggestion, VisualizationSuggestionsHandler } from '@grafana/data';
import { t } from '@grafana/i18n';
import { BigValueColorMode, BigValueGraphMode } from '@grafana/schema';

import { Options } from './panelcfg.gen';

export const statSuggestionsHandler: VisualizationSuggestionsHandler<Options> = (ds) => {
  if (!ds.hasData) {
    return;
  }
