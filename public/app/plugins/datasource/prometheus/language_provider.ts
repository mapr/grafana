...
const HISTOGRAM_SELECTOR = 'HISTOGRAM_SELECTOR';
...
export default class PromQlLanguageProvider extends LanguageProvider {
  ...
  processHistogramMetrics = (data: string[]) => {
    const { keys, values } = processHistogramLabels(data);
    this.labelKeys[HISTOGRAM_SELECTOR] = keys;
    this.labelValues[HISTOGRAM_SELECTOR] = values;
