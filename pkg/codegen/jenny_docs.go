...
func NewDocsJenny(docsPath string) codejen.OneToOne[SchemaForGen] {
	return DocsJenny{
		DocsPath: docsPath,
	}
}
...
// Copied from https://github.com/marcusolsson/json-schema-docs and slightly changed to fit the NewDocsJenny
