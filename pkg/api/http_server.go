...
type HTTPServer struct {
	...
	DatasourcePermissionService DatasourcePermissionService
}
...
func ProvideHTTPServer(opts ServerOptions, cfg *setting.Cfg, routeRegister routing.RouteRegister, bus bus.Bus,
	...
	notificationService *notifications.NotificationService, filterQuery DatasourcePermissionService) (*HTTPServer, error) {
	web.Env = cfg.Env
	m := web.New()
	...
	hs := &HTTPServer{
		...
		DatasourcePermissionService: filterQuery,
	}
	if hs.Listener != nil {
