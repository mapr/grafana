...
func Initialize(ctx context.Context, cfg *setting.Cfg, opts Options, apiOpts api.ServerOptions) (*Server, error) {
	...
	azurePromMigrationService := promtypemigration.ProvideAzurePromMigrationService(service15, pluginstoreService, repoManager, pluginInstaller, cfg)
	amazonPromMigrationService := promtypemigration.ProvideAmazonPromMigrationService(service15, pluginstoreService, repoManager, pluginInstaller, cfg)
