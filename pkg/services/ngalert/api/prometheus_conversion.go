...
func (f *ConvertPrometheusApiHandler) handleRouteConvertPrometheusListAlertmanagerConfigs(ctx *contextmodel.ReqContext) response.Response {
	return f.svc.RouteConvertPrometheusListAlertmanagerConfigs(ctx)
}
